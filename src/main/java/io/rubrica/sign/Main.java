...
import io.rubrica.keystore.UKCAppleKeyStoreProvider;
import io.rubrica.keystore.UKCGenericAppleKeyStoreProvider;
import io.rubrica.keystore.UKCLinuxKeyStoreProvider;
...
public class Main {
	...
	// ARCHIVO
	private static final String ARCHIVO = "/Users/elomas/Desktop/TEST/ORGANIZACION-ARCHIVO/organizacionarchivo.p12";
...
//    private static final String FILE = "/home/mfernandez/Test/Verify/05.pdf";
	private static final String FILE = "/Users/elomas/Desktop/TEST/Prueba Instituciones Publicas-signed.pdf";
...
//		 KeyStore keyStore = ksp.getKeystore(PASSWORD.toCharArray());
		...
		KeyStore keyStore = new UKCGenericAppleKeyStoreProvider().getKeystore();
