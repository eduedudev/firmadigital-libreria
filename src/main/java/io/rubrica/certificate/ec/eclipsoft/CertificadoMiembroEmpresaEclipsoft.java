 ...
 */
public class CertificadoMiembroEmpresaEclipsoft extends CertificadoEclipsoft implements CertificadoPersonaJuridica {

    public CertificadoMiembroEmpresaEclipsoft(X509Certificate certificado) {
        super(certificado);
    }
