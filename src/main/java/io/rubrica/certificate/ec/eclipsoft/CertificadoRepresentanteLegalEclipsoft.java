 ...
 */
public class CertificadoRepresentanteLegalEclipsoft extends CertificadoEclipsoft implements CertificadoRepresentanteLegal {

    public CertificadoRepresentanteLegalEclipsoft(X509Certificate certificado) {
        super(certificado);
    }
