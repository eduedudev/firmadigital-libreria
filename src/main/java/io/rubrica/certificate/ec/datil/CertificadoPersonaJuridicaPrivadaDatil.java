 ...
 * @author Eduardo Raad
 */
public class CertificadoPersonaJuridicaPrivadaDatil extends CertificadoDatil implements CertificadoPersonaJuridica {

    public CertificadoPersonaJuridicaPrivadaDatil(X509Certificate certificado) {
        super(certificado);
    }
