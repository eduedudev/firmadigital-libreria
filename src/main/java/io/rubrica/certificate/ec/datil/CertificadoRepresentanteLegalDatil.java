 ...
 * @author Eduardo Raad
 */
public class CertificadoRepresentanteLegalDatil extends CertificadoDatil implements CertificadoRepresentanteLegal {

    public CertificadoRepresentanteLegalDatil(X509Certificate certificado) {
        super(certificado);
    }
