 ...
 */
package ec.gob.firmadigital.libreria.validaciones;
...
public class Fichero {
    ...
    public static String rutaPdf() throws Exception {
        String ruta = "";
        javax.swing.JFileChooser elegirRuta = new javax.swing.JFileChooser(
                new java.io.File(System.getProperty("user.home")));
        elegirRuta.setAcceptAllFileFilterUsed(false);
        elegirRuta.setFileFilter(new ec.gob.firmadigital.libreria.validaciones.FiltrarArchivosPdf());
        ...
        if (opcionElegida == javax.swing.JFileChooser.APPROVE_OPTION) {
            ...
            if (file.exists() && file.isFile()) {
                if (javax.swing.JOptionPane.YES_OPTION == javax.swing.JOptionPane.showConfirmDialog(null,
                        "El archivo será sobrescrito. Desea continuar?", "Confirmacion",
    ...
    public static String ruta(java.io.File archivo, String extencion) throws Exception {
        ...
        if (opcionElegida == javax.swing.JFileChooser.APPROVE_OPTION) {
            ...
            if (archivoEscogido.indexOf(extencion, archivoEscogido.indexOf(extencion) + 1) > -1) {
                archivoEscogido = archivoEscogido.substring(0,
                        archivoEscogido.indexOf(extencion, archivoEscogido.indexOf(extencion) + 1));
            }
    ...
    public static void abrirFichero(String rutaFichero) {
        ...
        if (java.awt.Desktop.isDesktopSupported() == true) {
            ...
            try {
                if (archivo.exists() == true) {
                    ...
                    javax.swing.JOptionPane.showMessageDialog(null,
                            "No se encontrar el archivo: " + archivo.getAbsolutePath(), "Aviso",
            ...
            javax.swing.JOptionPane.showMessageDialog(null,
                    "No se puede ejecutar el comando de apertura en este sistema operativo", "Aviso",
                    javax.swing.JOptionPane.WARNING_MESSAGE);
        }
    }
     ...
     */
    public static void ficheros(String pathInicial, String mascara, java.util.LinkedList<java.io.File> listaFicheros,
        ...
        if (directorioInicial.isDirectory()) {
            ...
            for (int i = 0; i < ficheros.length; i++) {
                if (ficheros[i].isDirectory() && busquedaRecursiva) {
                    ficheros(ficheros[i].getAbsolutePath(), mascara, listaFicheros, busquedaRecursiva);
