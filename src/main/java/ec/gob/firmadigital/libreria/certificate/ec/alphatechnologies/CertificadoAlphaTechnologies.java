...
public class CertificadoAlphaTechnologies {
    ...
    private CertificadoAlphaTechnologies() {
    }
    ...
    public static final class Ext {
        ...
        // OIDs de tipo de certificado.
        public static final String OID_TIPO_PERSONA_NATURAL = "1.3.6.1.4.1.56105.2.1";
        public static final String OID_TIPO_PERSONA_JURIDICA = "1.3.6.1.4.1.56105.2.2";
        public static final String OID_TIPO_MIEMBRO_EMPRESA = "1.3.6.1.4.1.56105.2.3";
