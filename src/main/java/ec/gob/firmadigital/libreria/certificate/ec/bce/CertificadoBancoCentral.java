 ...
 */
public class CertificadoBancoCentral {

    private CertificadoBancoCentral() {
    }
...
//        public static final String OID_TIPO_REPRESENTANTE_LEGAL = "1.3.6.1.4.1.56105.2.3.1";
    ...
    public static final class Ext {
        ...
        // OIDs de tipo de certificado:
        public static final String OID_TIPO_PERSONA_NATURAL = "1.3.6.1.4.1.37947.2.1.1";
        public static final String OID_TIPO_PERSONA_JURIDICA = "1.3.6.1.4.1.37947.2.2.1";
        public static final String OID_TIPO_FUNCIONARIO_PUBLICO = "1.3.6.1.4.1.37947.2.3.1";
        public static final String OID_SELLADO_TIEMPO = "1.3.6.1.4.1.37947.4.1";
