...
/**
 * Certificado de persona natural (Subject).<br>
 * Emitido por CORPNEWBEST CIA. LTDA.
 *
 * @author Misael Fernández, CORPNEWBEST CIA. LTDA.
 */
public class CertificadoSubjPersonaNaturalCorpNewBest
        extends CertificadoSubjImpl
        implements CertificadoPersonaNatural {

    public CertificadoSubjPersonaNaturalCorpNewBest(X509Certificate certificado) {
        super(certificado);
    }
}
