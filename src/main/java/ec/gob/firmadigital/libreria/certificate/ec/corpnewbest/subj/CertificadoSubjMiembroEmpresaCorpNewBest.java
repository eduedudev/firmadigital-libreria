...
/**
 * Certificado de miembro de empresa (Subject).<br>
 * Emitido por CORPNEWBEST CIA. LTDA.
 *
 * @author Misael Fernández, CORPNEWBEST CIA. LTDA.
 */
public class CertificadoSubjMiembroEmpresaCorpNewBest
        extends CertificadoSubjImpl
        implements CertificadoMiembroEmpresa {

    public CertificadoSubjMiembroEmpresaCorpNewBest(X509Certificate certificado) {
        super(certificado);
    }
