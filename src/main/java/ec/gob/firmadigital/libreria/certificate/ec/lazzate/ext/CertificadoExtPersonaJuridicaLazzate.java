 ...
 */
package ec.gob.firmadigital.libreria.certificate.ec.lazzate.ext;

import ec.gob.firmadigital.libreria.certificate.ec.CertificadoPersonaJuridica;
import static ec.gob.firmadigital.libreria.certificate.ec.lazzate.CertificadoLazzate.Ext.*;
 ...
 */
public class CertificadoExtPersonaJuridicaLazzate
        extends CertificadoExtImplLazzate
        implements CertificadoPersonaJuridica {

    public CertificadoExtPersonaJuridicaLazzate(X509Certificate certificado) {
        super(certificado);
    }
