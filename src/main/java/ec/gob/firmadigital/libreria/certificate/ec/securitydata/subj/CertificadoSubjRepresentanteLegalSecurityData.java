 ...
 * S.A.
 */
public class CertificadoSubjRepresentanteLegalSecurityData extends CertificadoSubjImplSecurityData
        implements CertificadoRepresentanteLegal {

    public CertificadoSubjRepresentanteLegalSecurityData(X509Certificate certificado) {
        super(certificado);
    }
