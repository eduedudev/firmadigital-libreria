...
import static ec.gob.firmadigital.libreria.certificate.ec.appfirmas.CertificadoAppFirmas.Subj.*;
 ...
 */
public class CertificadoSubjRepresentanteLegalAppFirmas 
        extends CertificadoSubjImplAppFirmas
        implements CertificadoRepresentanteLegal {

    public CertificadoSubjRepresentanteLegalAppFirmas(X509Certificate certificado) {
        super(certificado);
    }
