...
/**
 * Certificado de sello electrónico (Subject).<br>
 * Emitido por CORPNEWBEST CIA. LTDA.
 *
 * @author Misael Fernández, CORPNEWBEST CIA. LTDA.
 */
public class CertificadoSubjSelloElectronicoCorpNewBest
        extends CertificadoSubjImpl
        implements CertificadoSelloElectronico {

    public CertificadoSubjSelloElectronicoCorpNewBest(X509Certificate certificado) {
        super(certificado);
    }
