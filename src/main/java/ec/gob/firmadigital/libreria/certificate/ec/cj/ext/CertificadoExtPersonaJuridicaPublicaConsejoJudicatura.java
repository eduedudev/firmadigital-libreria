...
/**
 * Certificado de Persona Juridica Pública<br>
 * emitido por el CONSEJO DE LA JUDICATURA
 *
 * @author Misael Fernández, CONSEJO DE LA JUDICATURA
 */
public class CertificadoExtPersonaJuridicaPublicaConsejoJudicatura
        extends CertificadoExtImplConsejoJudicatura
        implements CertificadoPersonaJuridica {

    public CertificadoExtPersonaJuridicaPublicaConsejoJudicatura(X509Certificate certificado) {
        super(certificado);
    }
