...
public final class XmlStyle {
     ...
     * @param headless Indica si deben omitirse las interacciones con el usuario
     * mediante interfaz gr&aacute;fico
     * @throws IOException Cuando hay errores de entrada / salida
     * @throws CannotDereferenceException Si no se puede obtener el estilo
     * referenciado
     * @throws IsInnerlException Si la referencia apunta a un elemento dentro
     * del propio XML
     ...
     * @throws IOException Si no se puede analizar adecuadamente la cabecera de
     * estilo
     */
     ...
     * @param headless <code>true</code> si <b>no</b> se desea que se pregunte
     * al usuario para dereferenciar las hojas de estilo enlazadas con rutas
     * locales
     * @return Documento DOM con la hoja de estilo
     * @throws CannotDereferenceException Si no se puede dereferenciar
     * @throws IsInnerlException Si no se puede dereferenciar por ser una
     * referencia local
     * @throws ReferenceIsNotXmlException Si el objeto dereferenciado no puede
     * transformarse en un Documento DOM
     */
