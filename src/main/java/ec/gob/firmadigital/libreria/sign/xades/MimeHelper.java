...
public final class MimeHelper {
     ...
     * extensi&oacute;n o el MimeType de unos datos.
     */
    ...
    /**
     * Obtiene el MimeType correspondiente a un OID concreto. Si no conoce el
     * MimeType asociado, devuelve el gen&eacute;rico de datos binarios
     * (DEFAULT_MIMETYPE).
     *
    ...
    /**
     * Carga el fichero de propiedades que relaciona OID de formato con su
     * MimeType correspondiente.
     *
     ...
     *
     * @return MimeType de los datos o <code>null</code> si no se pudo detectar.
     ...
     * analizados.
     *
     * @return Extensi&oacute;n para un fichero de datos o {@code null} si no se
     * conoce el tipo. La extensi&oacute;n se devuelve sin el punto separador.
    ...
    /**
     * Obtiene la extensi&oacute;n que debe corresponder al tipo de dato en base
     * a una serie de comprobaciones no englobadas en el an&aacute;lisis incial.
     *
    ...
    /**
     * Obtiene la descripci&oacute;n que debe corresponder al tipo de dato en
     * base a una serie de comprobaciones no englobadas en el an&aacute;lisis
     * incial.
     *
     * @param mimeType Tipo de dato.
     * @return Descripci&oacute;n que le corresponde a un fichero con esos datos
     * o {@code null} si no se conoce.
     */
    ...
    /**
     * Indica si unos datos son un fichero ZIP, independientemente de que ese
     * ZIP se corresponda con otro formato basado en el mismo (como los ficheros
     * DOCX, ODT,...).
     *
     * @return {@code true} si los datos son un ZIP, {@code false} en caso de
     * que no sean un ZIP o que no se puedan analizar.
     */
    public boolean isZipData() {
        ...
        return this.data[0] == (byte) 0x50 && this.data[1] == (byte) 0x4B && (this.data[2] == (byte) 0x03 && this.data[3] == (byte) 0x04
    ...
    static class MimeInfo {
        ...
        /**
         * Indica si se han realizado comprobaciones adicionales para verificar
         * si el tipo de dato es el que se ha establecido.
         */
        ...
        /**
         * Indica si se han realizado comprobaciones adicionales para verificar
         * si la extension es la que se ha establecido.
         */
        ...
        /**
         * Indica si se han realizado comprobaciones adicionales para verificar
         * si la descripci&oacute;n es la que se ha establecido.
         */
