...
public final class AOFileUtils {
    ...
    static final Logger LOGGER = Logger.getLogger(AOFileUtils.class.getName()); //$NON-NLS-1$
    ...
    /**
     * Valor bandera para indicar si la variable posixSupported se ha
     * inicializado.
     */
     ...
     * @throws IOException Cuando ocurre un error al leer los datos o crear el
     * temporal.
     */
     ...
     * Inspirado en:
     * <a href="http://www.rgagnon.com/javadetails/java-0661.html">http://www.rgagnon.com/javadetails/java-0661.html</a>.
     *
     * @param path Nombre de ruta de fichero.
     * @param limit L&iacute;mite de caracteres en el nombre de salida.
     * @return Nombre de ruta de fichero acortado, con puntos suspensivos en la
     * mitad, al n&uacute;mero l&iacute;mite de caracteres indicado.
     */
        ...
        try {
            ...
            reader.setErrorHandler(
                ...
                private void log(final Exception e) {
                    LOGGER.log(Level.FINE, "El documento no es un XML: {0}", e); //$NON-NLS-1$
                }
            }
            );
    ...
    /**
     * Establece permisos de lectura y escritura de un fichero para todos los
     * usuarios. No lanza error en ning&uacute;n caso.
     *
     ...
     *
     * @return {@code true} si admite atributos POSIX, {@code false} en caso
     * contrario.
     */
