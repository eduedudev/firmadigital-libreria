...
final class EscapeHelper {
     ...
     * </ol>
     * <p>
     * Y siguiendo los puntos, el apartado 3 (<i>Parsing a String Back to a
     * Distinguished Name</i>) define:
     * </p>
     *
     * <pre>
     ...
     * </pre>
     *
     * Y tal y como se recoge en <a href=
     * "http://tools.ietf.org/html/rfc4512">http://tools.ietf.org/html/rfc4512</a>
     * se puede observar:
     *
     * <pre>
     ...
     * </pre>
     *
     * Dejando as&iacute; claro que caracteres requieren un tratamiento especial
     * (<i>escape</i>):
     *
     * <pre>
     ...
     * </pre>
     *
     * Lo cual deja la posibilidad abierta de hacer el tratamiento RFC4515-3 de
     * forma manual.<br>
     * No obstante, es posible una aproximaci&oacute;n m&aacute;s sencilla
     * atendiendo al punto 2.4 (<i>Converting an AttributeValue from ASN.1 to a
     * String</i>), donde podemos leer:
     *
     * <pre>
     ...
     * </pre>
     *
     * Lo cual se ampl&iacute;a seg&uacute;n XMLDSig (<a href=
     * "http://www.w3.org/TR/xmldsig-core/">http://www.w3.org/TR/xmldsig-core/</a>)
     * en su punto 4.5.4.1 indicando que los espacios al inicio y al final se
     * reemplazan por '&#92;20' en lugar de por '&#92; ' adem&aacute;s de las
     ...
     * <i>#hex</i>
     * para codificar el <code>KeyName</code> de XAdES cuando contenga un DN
     * X.500, cosa que <u>no</u> se est&aacute; haciendo.
     * <p>
     ...
     * @return Nombre X.500 de entrada con sus caracteres especiales tratados
     * seg&uacute;n la RFC-4514.
     */
    ...
    private static String escapeCharacters(final String str) {
        return str.replace("\u00e1", "\\C3\\A1") // a minuscula con tilde aguda
                .replace("\u00e9", "\\C3\\A9") // e minuscula con tilde aguda
                .replace("\u00ed", "\\C3\\AD") // i minuscula con tilde aguda
                .replace("\u00f3", "\\C3\\B3") // o minuscula con tilde aguda
                .replace("\u00fa", "\\C3\\BA") // u minuscula con tilde aguda
                .replace("\u00c1", "\\C3\\81") // A mayuscula con tilde aguda
                .replace("\u00c9", "\\C3\\89") // E mayuscula con tilde aguda
                .replace("\u00cd", "\\C3\\8D") // I mayuscula con tilde aguda
                .replace("\u00d3", "\\C3\\93") // O mayuscula con tilde aguda
                .replace("\u00da", "\\C3\\9A") // U mayuscula con tilde aguda

                .replace("\u00f1", "\\C3\\B1") // n minuscula con virgulilla
                .replace("\u00d1", "\\C3\\91") // N mayuscula con virgulilla

                .replace("\u00e7", "\\C3\\A7") // c minuscula con cedilla
                .replace("\u00c7", "\\C3\\87") // C mayuscula con cedilla

                .replace("\u00e0", "\\C3\\A0") // a minuscula con tilde grave
                .replace("\u00e8", "\\C3\\A8") // e minuscula con tilde grave
                .replace("\u00ec", "\\C3\\AC") // i minuscula con tilde grave
                .replace("\u00f2", "\\C3\\B2") // o minuscula con tilde grave
                .replace("\u00f9", "\\C3\\B9") // u minuscula con tilde grave
                .replace("\u00c0", "\\C3\\80") // A mayuscula con tilde grave
                .replace("\u00c8", "\\C3\\88") // E mayuscula con tilde grave
                .replace("\u00cc", "\\C3\\8C") // I mayuscula con tilde grave
                .replace("\u00d2", "\\C3\\92") // O mayuscula con tilde grave
                .replace("\u00d9", "\\C3\\99") // U mayuscula con tilde grave

                .replace("\u00fc", "\\C3\\BC") // u minuscula con dieresis
                .replace("\u00dc", "\\C3\\9C") // U mayuscula con dieresis

                .replace("\u00bf", "\\C2\\BF") // Apertura de interrogacion
                .replace("\u00a1", "\\C2\\A1") // Apertura de exclamacion

                .replace("\u00b5", "\\C2\\B5") // Simbolo de "micro"
                .replace("\u00ba", "\\C2\\BA") // Simbolo de ordinal masculino
                .replace("\u00aa", "\\C2\\AA") //
                ;
    }
