 ...
 * @author mfernandez
 */
public class CertificadoDepartamentoEmpresaConsejoJudicatura extends CertificadoConsejoJudicatura
        implements CertificadoPersonaJuridica {

    public CertificadoDepartamentoEmpresaConsejoJudicatura(X509Certificate certificado) {
        super(certificado);
    }
