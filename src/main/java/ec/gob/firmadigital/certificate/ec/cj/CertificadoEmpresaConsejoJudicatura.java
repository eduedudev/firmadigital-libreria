 ...
 * @author mfernandez
 */
public class CertificadoEmpresaConsejoJudicatura extends CertificadoConsejoJudicatura
        implements CertificadoPersonaJuridica {

    public CertificadoEmpresaConsejoJudicatura(X509Certificate certificado) {
        super(certificado);
    }
