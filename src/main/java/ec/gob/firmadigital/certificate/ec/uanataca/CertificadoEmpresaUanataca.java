 ...
 */
public class CertificadoEmpresaUanataca extends CertificadoUanataca implements CertificadoPersonaJuridica {

    public CertificadoEmpresaUanataca(X509Certificate certificado) {
        super(certificado);
    }
