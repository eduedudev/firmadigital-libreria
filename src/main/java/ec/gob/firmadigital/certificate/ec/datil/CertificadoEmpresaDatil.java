 ...
 */
public class CertificadoEmpresaDatil extends CertificadoDatil implements CertificadoPersonaJuridica {

    public CertificadoEmpresaDatil(X509Certificate certificado) {
        super(certificado);
    }
