 ...
 * @author Eduardo Raad
 */
public class CertificadoMiembroEmpresaDatil extends CertificadoDatil implements CertificadoPersonaJuridica {

    public CertificadoMiembroEmpresaDatil(X509Certificate certificado) {
        super(certificado);
    }
