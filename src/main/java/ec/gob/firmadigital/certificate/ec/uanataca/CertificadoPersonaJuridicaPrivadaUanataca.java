 ...
 */
public class CertificadoPersonaJuridicaPrivadaUanataca extends CertificadoUanataca implements CertificadoPersonaJuridica {

    public CertificadoPersonaJuridicaPrivadaUanataca(X509Certificate certificado) {
        super(certificado);
    }
