 ...
 * @author mfernandez
 */
public class CertificadoMiembroEmpresaConsejoJudicatura extends CertificadoConsejoJudicatura
        implements CertificadoPersonaJuridica {

    public CertificadoMiembroEmpresaConsejoJudicatura(X509Certificate certificado) {
        super(certificado);
    }
