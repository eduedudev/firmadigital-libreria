 ...
 * @author mfernandez
 */
public class CertificadoPersonaJuridicaPrivadaConsejoJudicatura extends CertificadoConsejoJudicatura
        implements CertificadoPersonaJuridica {

    public CertificadoPersonaJuridicaPrivadaConsejoJudicatura(X509Certificate certificado) {
        super(certificado);
    }
