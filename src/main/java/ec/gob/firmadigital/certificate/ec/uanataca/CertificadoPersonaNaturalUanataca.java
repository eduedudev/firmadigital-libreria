 ...
 */
public class CertificadoPersonaNaturalUanataca extends CertificadoUanataca implements CertificadoPersonaNatural {

    public CertificadoPersonaNaturalUanataca(X509Certificate certificado) {
        super(certificado);
    }
