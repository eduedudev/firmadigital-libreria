 ...
 */
public class CertificadoRepresentanteLegalUanataca extends CertificadoUanataca implements CertificadoRepresentanteLegal {

    public CertificadoRepresentanteLegalUanataca(X509Certificate certificado) {
        super(certificado);
    }
