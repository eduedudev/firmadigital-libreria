 ...
 * @author Eduardo Raad
 */
public class CertificadoPersonaNaturalDatil extends CertificadoDatil implements CertificadoPersonaNatural {

    public CertificadoPersonaNaturalDatil(X509Certificate certificado) {
        super(certificado);
    }
